...
public class MemberLevelServiceImpl extends ServiceImpl<MemberLevelMapper, MemberLevel> implements MemberLevelService {
    ...
    @Override
    public List<MemberLevel> getMemberLevel(String memberLevel) {

        QueryWrapper<MemberLevel> memberLevelQueryWrapper = new QueryWrapper<>();
        memberLevelQueryWrapper.eq("default_status",memberLevel);
        List<MemberLevel> list = baseMapper.selectList(memberLevelQueryWrapper);
