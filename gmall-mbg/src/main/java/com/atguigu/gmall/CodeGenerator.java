...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("F:\\gmall\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("Lyh");
        ...
        dsc.setUrl("jdbc:mysql://192.168.75.130:3316/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
